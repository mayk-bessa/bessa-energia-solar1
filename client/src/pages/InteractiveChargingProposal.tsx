...
import { ArrowLeft, Calculator, CirclePlus, FileDown, Minus, Plus, Trash2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 print:bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section className="mb-6 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <Button onClick={() => window.print()} className="bg-[#ff6900] text-white hover:bg-[#e35e00] print:hidden">
            <FileDown className="mr-2 h-4 w-4" /> Imprimir ou salvar PDF
          </Button>
        </section>
        ...
        <section className="mb-6 grid gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input id="seller-name" value={sellerName} onChange={(event) => setSellerName(event.target.value)} placeholder="Nome do vendedor" />
          </div>
        </section>
